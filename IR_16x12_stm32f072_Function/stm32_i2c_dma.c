...
int stm32_i2c_dma_write_read(I2C_TypeDef *I2Cx,uint8_t address,void *vdata,int length,void *vout,int olength)
{
 ...
 DMA1_Channel3->CCR |= DMA_CCR_PL_0 | DMA_CCR_TCIE | DMA_CCR_EN;  //prio: 1 , error DMA enable
 ...
 //The following 4 lines are NOT needed if one utilize interupt service rutine at the end of the  
